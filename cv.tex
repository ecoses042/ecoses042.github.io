...
\begin{center}
    ...
    \textbf{LinkedIn: }\href{https://www.linkedin.com/in/minsoo-song-448380370}{www.linkedin.com/in/minsoo-song-448380370}
\end{center}
...
\begin{enumerate}
    \item \small{\textbf{Structured but Silent: Probing Capability Requirements in LLM Hidden States} \\
    Kyojun Choo, \underline{Minsoo Song}, Yunju Kang, Chanjun Park$\dagger$ \\
    \textit{Findings of the 2026 Conference of the Asia-Pacific Chapter of the Association for Computational Linguistics and the International Joint Conference on Natural Language Processing (AACL-IJCNLP 2026)}}

    \item \small{\textbf{Auditing MCQA Benchmarks through Probability Landscapes} \\
    \underline{Minsoo Song}, Chanjun Park$\dagger$ \\
    \textit{Proceedings of the 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP 2026), Main Conference}}

    \item \small{\textbf{Beyond Consensus: Downward Bias and Role Asymmetry in Multi-Agent LLM Judges for Subjective Evaluation} \\
    \underline{Minsoo Song}, Chanwoo Kim, Sugyeong Eo$\dagger$, Chanjun Park$\dagger$ \\
    \textit{Findings of the 2026 Conference on Empirical Methods in Natural Language Processing (EMNLP 2026)}}
\end{enumerate}
...
%--------------------------------------------------------------
%  PATENTS
%  ※ 발명자 목록은 책임발명자(박찬준)와 본인만 적었습니다.
%    공동 발명자가 더 있으면 순서에 맞게 추가하세요.
%--------------------------------------------------------------
\seclabel{Patents}
\textbf{Domestic Patent Applications}
\begin{itemize}
    \item \small{\textbf{\kr{인공지능 모델 평가용 벤치마크를 분석하는 전자 장치 및 이의 동작 방법}} \\
    \kr{박찬준, 송민수} \\
    Korean Patent Application, filed on August 4, 2026 (Application No. 10-2026-0144925).} \vspace{0.4em}

    \item \small{\textbf{\kr{인공지능 평가 프로토콜을 분석하는 전자 장치 및 이의 동작 방법}} \\
    \kr{박찬준, 송민수} \\
